...
##################### split dataset ############################
################################################################
spl.var <- "C_waterNames"							## by which variables should the dataset be split? leave empty c() or set to NULL for *no* splitting by class variables, or provide one or more valid class variables to split along these variables; e.g. "C_Group", or c("C_Group", "C_Mode", ...)
...
# plotting 
pca.colorBy <- "C_Group"						## which variables to use for coloring the score plots. leave empty c() or set to NULL for using all available class-variables for coloring. Provide a character vector with valid class variable names to color along these variables; e.g. c("C_Group", "C_Temp", "C_RelHum", ...)
...
sim.vars <- "C_Group"						## which variables should be use to group the data? Leave empty c() or set to NULL for using all available class-variables, or provide a character vector with valid class variable names to group along these variables; e.g. "C_Group", or c("C_Group", "C_FooBar", ...)
...
aqg.vars <- c("C_Group", "C_Group")			## which variables should be use to group the data? Provide a character vector with valid class variable names to group along these variables; e.g. "C_Group", or c("C_Group", "C_FooBar", ...)
aqg.nrCorr <- "def"						## please see the help for ?calc_aqg_args and ?plot_aqg_args for further information regarding these arguments.
aqg.spectra <- FALSE
aqg.minus <- c("Cont", "GDum")
